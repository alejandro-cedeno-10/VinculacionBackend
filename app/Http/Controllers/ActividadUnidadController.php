...
class ActividadUnidadController extends Controller
{
    ...
    {
        //
        $actividad= QueryBuilder::for(Actividad::class)
    ...
    {
        //
        $actividad=Cache::remember('actividads',30/60, function() use ($id)
		{
		...
		if(!$actividad)
		{
			return response()->json(
				...
				'message'=>'No se encuentra una actividad con ese identificador.',
				'identificador'=>$id
			])],404);
		}
